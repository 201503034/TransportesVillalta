...
public class DetalleFacDAO implements Operaciones {
    ...
    public String modificar(Object obj) {
        ...
        try {
            ...
            sql = "UPDATE detalle_factura SET idProducto =?, cantidad =?, "
                    + "precioUnitario=?, descripcionFactura=? "
            ...
            pst.setInt(5, df.getNoDetalle());
            pst.setInt(6, df.getFactura().getNoFactura());
    ...
    public List<?> consultar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                lst.add(new DetalleFactura(rs.getInt(1), fe, prod, rs.getInt(4), rs.getFloat(5), rs.getString(6)));
            }
            rs.close();
            sentencia.close();
            cn.close();
    ...
    public List<?> buscar(Object obj) {
        ...
        try {
            ...
            DetalleFactura df = (DetalleFactura) obj;
            Connection cn = this.conexion.conectar();
            sql = "SELECT * FROM detalle_factura WHERE noDetalle =? AND noFactura =?";
            PreparedStatement pst = cn.prepareStatement(sql);
            pst.setInt(1, df.getNoDetalle());
