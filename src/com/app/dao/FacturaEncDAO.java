...
public class FacturaEncDAO implements Operaciones {
    ...
    public List<?> consultar() {
        ...
        try {
            ...
            ResultSet rs = sentencia.executeQuery("SELECT * FROM factura_enc");
            while (rs.next()) {
                ...
                lst.add(new FacturaEncabezado(rs.getInt(1), rs.getDate(2), rs.getString(3), rs.getString(4), cp, cli));
            }
            rs.close();
            sentencia.close();
            cn.close();
